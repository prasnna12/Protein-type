...
const Footer = () => (
  <footer style={{
    ...
    <style>{`
      ...
      /* Base icon — soft ambient glow at rest */
      .f-icon {
        width: 40px;
        height: 40px;
        display: flex;
      ...
      /* Instagram — pink ambient at rest */
      .f-icon-ig {
        color: rgba(225, 48, 108, 0.6);
        border: 1px solid rgba(225, 48, 108, 0.25);
        background: rgba(225, 48, 108, 0.05);
        box-shadow:
          0 0 8px rgba(225, 48, 108, 0.15),
          inset 0 0 8px rgba(225, 48, 108, 0.05);
      ...
      .f-icon-ig:hover {
        ...
        box-shadow:
          0 0 20px rgba(225, 48, 108, 0.55),
          0 0 40px rgba(225, 48, 108, 0.2),
          inset 0 0 12px rgba(225, 48, 108, 0.1);
        animation: none;
      }

      /* YouTube — red ambient at rest */
      .f-icon-yt {
        color: rgba(255, 32, 32, 0.6);
        border: 1px solid rgba(255, 32, 32, 0.25);
        background: rgba(255, 32, 32, 0.05);
        box-shadow:
          0 0 8px rgba(255, 32, 32, 0.15),
          inset 0 0 8px rgba(255, 32, 32, 0.05);
      ...
      .f-icon-yt:hover {
        ...
        transform: scale(1.2) translateY(-2px);
        box-shadow:
          0 0 20px rgba(255, 32, 32, 0.55),
          0 0 40px rgba(255, 32, 32, 0.2),
          inset 0 0 12px rgba(255, 32, 32, 0.1);
        animation: none;
      }

      /* Subtle breathing pulse animations */
      @keyframes igPulse {
        0%, 100% { box-shadow: 0 0 6px rgba(225,48,108,0.12), inset 0 0 6px rgba(225,48,108,0.04); }
        50%       { box-shadow: 0 0 14px rgba(225,48,108,0.3), inset 0 0 10px rgba(225,48,108,0.08); }
      }
      @keyframes ytPulse {
        0%, 100% { box-shadow: 0 0 6px rgba(255,32,32,0.12), inset 0 0 6px rgba(255,32,32,0.04); }
        50%       { box-shadow: 0 0 14px rgba(255,32,32,0.3), inset 0 0 10px rgba(255,32,32,0.08); }
      }
